...
language_data = {
    "english": {
        ...
        "skip_start_label": "Skip Start Seconds",
        "skip_start_info": "Skip the first N seconds of audio for transcription. Useful for ignoring intro music or theme songs that may be misinterpreted as speech. The original audio is preserved.",
